...
export default function Admins() {
     ...
     const handleSubmit = (event) => {
       ...
       const { telegramAdmin, telegramUsername } = formData;

       console.log("FROM ADMINS TAB: ", JSON.stringify(formData));

       if (telegramAdmin && telegramUsername) {
        ...
        <div id="admin" className="w-full">
          ...
          <form onSubmit={handleSubmit}>
            <div id="account-settings" className="space-y-2">
              <div id="project-name">
                <label className="sr-only">Admin Telegram</label>
                <input
